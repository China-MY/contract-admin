    ...
    <a-modal v-model:open="modalVisible" :title="modalTitle" width="65%" :footer="null" destroyOnClose>
      <a-form v-if="modalVisible" :model="form" layout="vertical" @finish="handleSave">
        <a-row :gutter="24">
          ...
          <a-col :span="8"><a-form-item label="付款方"><a-input v-model:value="form.payer" /></a-form-item></a-col>
          <a-col :span="8"><a-form-item label="收款方"><a-input v-model:value="form.payee" /></a-form-item></a-col>
